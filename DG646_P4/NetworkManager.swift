...
//  DG646_P4
//
//  Created by David Goldfarb on 12/2/22.
//

import Foundation
import Alamofire

//This is all for networking, however backend onlu got routes to me five hours before submission so I was unable to connect the networking routes
